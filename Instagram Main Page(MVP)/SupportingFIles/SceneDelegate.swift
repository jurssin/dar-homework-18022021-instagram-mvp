...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let interestingVC = UINavigationController(rootViewController: InterestingViewController())
        ...
        tabBarVC.setViewControllers([mainVC, interestingVC, newPostVC, shopVC, profileVC
        ], animated: true)
